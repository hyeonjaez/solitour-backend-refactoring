...
//        ZoneCategoryResponse zoneCategoryResponse = new ZoneCategoryResponse(2L, parentZoneCategory, "서울");
//
//        when(zoneCategoryService.getZoneCategoryById(any(Long.class))).thenReturn(zoneCategoryResponse);
//
...
//                .andExpect(jsonPath("$.parentZoneCategory.id").value(parentZoneCategory.getId()))
//                .andExpect(jsonPath("$.parentZoneCategory.name").value(parentZoneCategory.getName()))
...
//                        responseFields(
//                                fieldWithPath("id").description("ZoneCategory ID"),
//                                fieldWithPath("parentZoneCategory.id").description("parentZoneCategory ID"),
//                                fieldWithPath("parentZoneCategory.name").description("parentZoneCategory Name"),
//                                fieldWithPath("name").description("ZoneCategory 이름")
//                        )));
//
//        verify(zoneCategoryService, times(1)).getZoneCategoryById(any(Long.class));
//    }
//
//    @Test
...
//
//        ReflectionTestUtils.setField(zoneCategoryRegisterRequest, "parentId", parentZoneCategory.getId());
...
//                        requestFields(
//                                fieldWithPath("parentId").description("ParentZoneCategory 아이디"),
//                                fieldWithPath("name").description("ZoneCategory 이름")
//                        ),
//                        responseFields(
//                                fieldWithPath("id").description("ZoneCategory 아이디"),
//                                fieldWithPath("parentZoneCategory.id").description("parentZoneCategory 아이디"),
//                                fieldWithPath("parentZoneCategory.name").description("parentZoneCategory 이름"),
//                                fieldWithPath("name").description("ZoneCategory 이름")
//                        )));
//
...
//        ZoneCategoryRegisterRequest zoneCategoryRegisterRequest = new ZoneCategoryRegisterRequest();
//
//        ReflectionTestUtils.setField(zoneCategoryRegisterRequest, "parentId", 0);
//        ReflectionTestUtils.setField(zoneCategoryRegisterRequest, "name", "서울");
//
//
//        mockMvc.perform(post("/api/zoneCategories")
...
//        ZoneCategoryRegisterRequest zoneCategoryRegisterRequest = new ZoneCategoryRegisterRequest();
//
//        ReflectionTestUtils.setField(zoneCategoryRegisterRequest, "parentId", 1L);
...
//        ReflectionTestUtils.setField(zoneCategoryModifyRequest, "parentId", parentZoneCategory.getId());
//        ReflectionTestUtils.setField(zoneCategoryModifyRequest, "name", "서울");
//
//        when(zoneCategoryService.modifyZoneCategory(any(Long.class), any(ZoneCategoryModifyRequest.class))).thenReturn(zoneCategoryResponse);
//
...
//                        responseFields(
//                                fieldWithPath("id").description("ZoneCategory 아이디"),
//                                fieldWithPath("parent id").description("ParentZoneCategory 아이디"),
//                                fieldWithPath("parent name").description("ParentZoneCategory 이름"),
//                                fieldWithPath("name").description("ZoneCategory 이름")
//                        )));
//
//        verify(zoneCategoryService, times(1)).modifyZoneCategory(any(Long.class), any(ZoneCategoryModifyRequest.class));
//    }
//
//    @Test
//    @DisplayName("")
//    void updateZoneCategoryValidationExceptionByParentIdMinSize() throws Exception {
//        ZoneCategoryModifyRequest zoneCategoryModifyRequest = new ZoneCategoryModifyRequest();
//
//        ReflectionTestUtils.setField(zoneCategoryModifyRequest, "id", 0L);
//        ReflectionTestUtils.setField(zoneCategoryModifyRequest, "name", "서울");
//
//        mockMvc.perform(put("/api/zoneCategories/{id}", 2)
//                        .content(new ObjectMapper().writeValueAsString(zoneCategoryModifyRequest))
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isBadRequest())
//                .andDo(document("ZoneCategory-create-error-parentId-min-size-0"));
//
//        verify(zoneCategoryService, never()).modifyZoneCategory(any(Long.class), any(ZoneCategoryModifyRequest.class));
//    }
//
//
//    @Test
...
//        ZoneCategoryModifyRequest zoneCategoryModifyRequest = new ZoneCategoryModifyRequest();
//
//        ReflectionTestUtils.setField(zoneCategoryModifyRequest, "id", 1L);
...
//                        )));
//
//        verify(zoneCategoryService, times(1)).deleteZoneCategory(any(Long.class));
//    }
//
//
//}